...
class Update1
{
	...
	private $db;
	private $method;
	function __construct($location = '', $descriptions = '', $categories = '',$images = '', $price = '', $numbers = '',$image1 = '',$image2 = '',$image3 = '',$image4 = '',$image5 = '',$image6 = '',$recommend = '',$currency = '',$userid = '',$city = '',$ad_id = '',$image_name = '')
	{
